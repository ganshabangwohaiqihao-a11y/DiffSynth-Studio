...
accelerate launch examples/flux/model_training/train.py \
  --dataset_base_path /share/home/202230550120/DiffSynth-Studio/output_2026.3.27 \
  --dataset_metadata_path /share/home/202230550120/DiffSynth-Studio/output_2026.3.27/metadata_kontext_train_enhanced_llm_mixed_clean.csv\
  ...
  --output_path "./models/train_new/FLUX.1-Kontext-dev_lora_learning_rate_constant_nochidu" \
  --tensorboard_log_dir "./models/train_new/FLUX.1-Kontext-dev_lora_learning_rate_constant_nochidu/tensorboard" \
  --lora_base_model "dit" \
