#!/usr/bin/env python3
"""
多GPU推理脚本：从metadata.csv读取数据，使用多个GPU并行推理Qwen-Image-Edit模型
用法:
  python qwen_image_multiprocess.py \
    --metadata-csv /share/home/202230550120/DiffSynth-Studio/data/diffsynth_example_dataset/qwen_image/Qwen-Image-Edit-2511/metadata_paired_test.csv \
    --lora-weights /share/home/202230550120/DiffSynth-Studio/models/Qwen-Image-train_2026.04.08.20:02/Qwen-Image-Edit-2511_lora/epoch-19.safetensors \
    --output-dir /share/home/202230550120/DiffSynth-Studio/examples/qwen_image/model_inference/infer_results_test \
    --num-gpu 1
"""
...
def main():
    parser = argparse.ArgumentParser(description="多GPU Qwen-Image-Edit推理脚本")
    ...
    print(f"\n{'='*70}")
    print(f"多GPU Qwen-Image-Edit推理脚本")
    print(f"{'='*70}")
